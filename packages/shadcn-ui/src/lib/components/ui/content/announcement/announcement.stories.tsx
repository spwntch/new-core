...
export const LongAnnouncement: Story = {
  args: {
    message:
      'This is a very long announcement message that should demonstrate how the Announcement component handles longer text content. It should wrap appropriately and still look good on different screen sizes.',
    href: '#',
  },
  play: playBasic,
};
