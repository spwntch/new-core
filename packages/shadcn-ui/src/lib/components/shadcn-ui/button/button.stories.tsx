...
const meta: Meta<typeof Button> = {
  ...
  argTypes: {
    variant: {
      ...
      description:
        'The variant of the button. It can be "default", "destructive", "outline", "secondary", "ghost", or "link".',
    },
    size: {
      control: { type: 'select' },
      options: ['default', 'sm', 'lg', 'icon'],
      description:
        'The size of the button. It can be "default", "sm", "lg", or "icon".',
    },
    asChild: {
      control: { type: 'boolean' },
      description:
        'Render the button as a different component while retaining the button styles.',
    },
    className: {
      control: { type: 'text' },
