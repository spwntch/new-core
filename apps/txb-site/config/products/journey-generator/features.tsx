...
import { User, MapPin, GraduationCap, Brain, Briefcase, Heart, Monitor } from 'lucide-react';
...
export const FEATURES: IContent = {
  ...
  subheading: {
    content: 'What You Can Expect from the AI Powered Journey Map Generator',
  },
  bullets: [
    {
      icon: <User />,
  ...
  body: {
    content: [
      'With our powerful software features, the AI Powered Journey Map Generator provides a 360-degree view of your ideal customers, enabling you to create personalized strategies that resonate deeply and drive results.',
    ],
    className: 'max-w-4xl',
  },
};